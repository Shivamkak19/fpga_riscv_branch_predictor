...
`endif
  ...
  //----------------------------------------------------------------------
  // Branch-predictor wires (only used when BP_ENABLED)
  //----------------------------------------------------------------------
`ifdef BP_ENABLED
  wire [31:0] pc_Fhl_w;
  wire [31:0] pc_Xhl_w;
  wire [31:0] pred_target_Fhl_w;
  wire        redirect_to_target_Xhl_w;
  wire        pred_target_match_Dhl_w;
  wire        bp_resolve_Xhl_w;
  wire        bp_correct_Xhl_w;
  wire        mispredict_Xhl_w;
`endif
...
`ifdef BP_ENABLED
    ...
    .pc_Fhl                 (pc_Fhl_w),
    .pc_Xhl                 (pc_Xhl_w),
    .pred_target_Fhl        (pred_target_Fhl_w),
    .redirect_to_target_Xhl (redirect_to_target_Xhl_w),
    .pred_target_match_Dhl  (pred_target_match_Dhl_w),
    .bp_resolve_Xhl         (bp_resolve_Xhl_w),
    .bp_correct_Xhl         (bp_correct_Xhl_w),
    .mispredict_Xhl         (mispredict_Xhl_w)
`endif
  );
